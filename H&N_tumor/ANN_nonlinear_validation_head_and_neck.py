...
def dataProcessing(data_x, data_y, batch_size, training_ratio, validation_ratio,
    ...
    data_x_FM = np.zeros(shape=(int(len(FM_indices)*3), data_x.shape[1])) # Size: FM_num*3 x SampleNum. 
...
def main(): 
    ...
    batch_size = 256
    learning_rate = 1e-4
    num_epochs = 4000 # Default: TBD. Previous default: 12000 or 4000.  
    training_ratio = 0.8
    validation_ratio = 0.1
    FM_num = 5
    PC_num = ML_VAE.LATENT_DIM # Optimal. (Default: 27. From Dan 09/02). 
    ...
    PRETRAINED_ENCODER_MODEL_PATH = "result/final/2_PC_num_27_VAE_Linear2_epoch_25000_scalar_100/model_checkpoints_autoencoder/model_final.pth" # Only for 'Pretrained' mode. 
    SAVED_GT_LIST = "result/final/2_PC_num_27_VAE_Linear2_epoch_25000_scalar_100/groundtruths_list.npy" # Only for 'Pretrained' mode. 
    SAVED_LATENT_LIST = "result/final/2_PC_num_27_VAE_Linear2_epoch_25000_scalar_100/latent_list.npy" # Only for 'Pretrained' mode. 
    ...
    mdict = {"FM_num": FM_num, "PC_num": PC_num, "batch_size": batch_size, # Numbers of FMs and principal components.
             ...
             "pred_y_list_train": pred_y_List_train, "test_y_List_train": test_y_List_train,
